...
export const AlojamientosActivados: React.FC = () => {
  ...
  const columns = [
    ...
    { field: 'familias_ingresaron', header: 'F. ingresaron', sortable: true },
    { field: 'familias_salieron', header: 'F. salieron', sortable: true },
    { field: 'personas_ingresaron', header: 'P. ingresaron', sortable: true },
    { field: 'personas_salieron', header: 'P. salieron', sortable: true },
